...
interp = QuadraticInterpolation(zero_rates, tenors; extrapolation=ExtrapolationType.Constant)
...
interp_bumped = QuadraticInterpolation(bumped_z, tenors; extrapolation=ExtrapolationType.Constant)
