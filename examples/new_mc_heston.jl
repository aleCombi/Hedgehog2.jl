using Revise,Hedgehog, Dates, Random, Accessors, Test
...
mc_method = MonteCarlo(dynamics, strategy, config)

# Solve with current seed
sol = Hedgehog.solve(prob, mc_method)
Hedgehog.get_final_samples(prob, mc_method)
