...
delta_mc = solve(gprob, FiniteDifference(ε), mc_method).greek
...
gamma_mc = solve(gprob2, FiniteDifference(ε), mc_method).greek
...
vega_mc = solve(gprob, FiniteDifference(ε), mc_method).greek
...
rho_mc = solve(gprob, FiniteDifference(ε), mc_method).greek
rho_an = solve(gprob, AnalyticGreek(), analytic_method).greek
