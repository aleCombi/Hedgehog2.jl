...
@testset "Antithetic Variates Variance Reduction" begin
    ...
    @testset "Black-Scholes Exact Simulation" begin
        ...
        results = analyze_antithetic_variance_reduction(
            bs_prob,
            bs_exact_method;
            num_paths = num_paths,
            seed = seed,
    ...
    @testset "Relative Variance Reduction Efficiency" begin
        ...
        # Compare results
        exact_results = analyze_antithetic_variance_reduction(
            bs_prob,
            bs_exact_method;
            num_paths = paths_comp,
            seed = seed_comp,
        )

        em_results = analyze_antithetic_variance_reduction(
            bs_prob,
            bs_em_method;
            num_paths = paths_comp,
            seed = seed_comp,
